...
export default function Layout({ children }: any) {
    return (
        <>
            ...
            <meta property="og:image" content="https://wrapped.schrodinger-hat.it/.netlify/functions/generator" />
            ...
            <meta name="twitter:image" content="https://wrapped.schrodinger-hat.it/.netlify/functions/generator" />
